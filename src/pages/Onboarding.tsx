        ...
        >
          {step === 1 && (
            <div className="glass p-6 sm:p-10">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-center">Setup Your Profile</h2>
          ...
          {step === 3 && (
            <div className="glass p-6 sm:p-10 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4">Upload Past Papers</h2>
          ...
          {step === 4 && (
            <div className="glass p-6 sm:p-10">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-center">Exam Details</h2>
          ...
          {step === 5 && (
            <div className="glass p-6 sm:p-10">
              <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-center">Ready to Start?</h2>
