...
import { suggestDependencies, getApiKey } from '@/services/geminiService';
...
export default function DependencyGraph() {
  ...
  return (
    <div className="h-screen w-full pt-16 relative bg-transparent">
      <div className="absolute top-20 sm:top-24 left-4 sm:left-8 z-20 pointer-events-none pr-4">
        <div className="mb-4 sm:mb-6 pointer-events-auto">
        ...
        <h1 className="text-2xl sm:text-3xl font-black mb-1 uppercase tracking-tight">Knowledge Map</h1>
        <p className="text-xs sm:text-sm text-muted-foreground mb-6 font-medium">Neural prerequisite mapping.</p>
        
        <div className="flex flex-wrap items-center gap-2 pointer-events-auto">
          <button
            onClick={hasApiKey ? handleGenerateDependencies : undefined}
