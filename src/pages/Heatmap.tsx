  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-6 max-w-7xl mx-auto relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 sm:mb-12">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black mb-1 uppercase tracking-tight">Mastery Heatmap</h1>
          <p className="text-xs sm:text-sm text-muted-foreground font-medium">Visualizing neural mapping across the entire curriculum.</p>
        </div>

        <div className="w-full md:w-auto flex items-center gap-1 bg-accent/30 p-1 rounded-xl border border-border overflow-x-auto no-scrollbar">
          {['All', 'Not Started', 'In Progress', 'Mastered'].map((f) => (
            <button 
              ...
              className={cn(
                ...
                filter === f ? "bg-primary text-primary-foreground shadow-lg shadow-primary/20" : "text-muted-foreground hover:text-foreground"
              )}
            >
              {f === 'Not Started' ? 'New' : f}
            </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 pb-24">
      ...
      {/* Legend */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 glass px-6 py-3 flex items-center justify-center gap-4 sm:gap-6 text-[10px] font-black uppercase tracking-widest bg-background/80 w-[calc(100%-2rem)] max-w-lg z-40 border border-border shadow-2xl">
        <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-muted border border-border"></div> <span className="hidden sm:inline">Not Started</span><span className="sm:hidden">New</span></div>
        <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-danger"></div> Weak</div>
        <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-warning"></div> Avg</div>
        <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-sm bg-success"></div> Mastered</div>
      </div>
