  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-12">
        {/* Hero Section */}
        <div className="xl:col-span-8 bg-card/50 border border-destructive/30 rounded-3xl p-6 sm:p-8 relative overflow-hidden group backdrop-blur-xl">
        ...
        <div className="xl:col-span-4 space-y-6">
          <div className="glass p-6 flex flex-col justify-between h-auto xl:h-full shadow-xl">
            <div>
      ...
      {/* Tabs */}
      <div className="flex gap-6 sm:gap-12 border-b border-border mb-8 px-4 overflow-x-auto no-scrollbar whitespace-nowrap">
        <button 
          onClick={() => setActiveTab('priority')}
          className={cn(
            "pb-4 text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] transition-all relative btn-touch",
        ...
        {activeTab === 'priority' ? (
          ...
          >
            <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10">
              {timeline.map((slot, i) => (
                <div key={i} className="flex flex-col sm:flex-row gap-4 sm:gap-12 items-start group">
                  <div className="w-full sm:w-40 shrink-0 text-base sm:text-lg font-mono font-bold text-muted-foreground pt-1 group-hover:text-destructive transition-colors">
                    {slot.time}
                  </div>
                  <div className="flex-1 pb-8 sm:pb-10 border-l-2 border-border pl-6 sm:pl-10 relative">
                    <div className={cn(
                     ...
                     <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                       <div>
                         <div className="text-xl sm:text-2xl font-bold group-hover:text-primary transition-colors mb-2">{slot.task}</div>
                         <div className={cn(
                       ...
                       {slot.status === 'Active' && (
                         <button 
                           ...
                           className="w-full sm:w-auto px-6 py-3 rounded-xl bg-destructive text-destructive-foreground text-xs font-black uppercase tracking-widest hover:opacity-90 transition-all shadow-xl shadow-destructive/20 btn-touch"
                         >
                           Engage Now
                         </button>
                       )}
