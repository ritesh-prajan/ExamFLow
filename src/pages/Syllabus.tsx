...
import { BookOpen, Search, Filter, MoreVertical, CheckCircle2, Clock, AlertCircle, Plus, X, Share2, Trash2, Edit3, ArrowUp, ArrowDown, Type, Check, FileText, ChevronDown } from 'lucide-react';
    ...
    <div className="min-h-screen pt-20 sm:pt-24 pb-12 px-4 sm:px-6 max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-6 mb-12">
        <div className="w-full lg:max-w-md">
          <h1 className="text-3xl sm:text-4xl font-black mb-2 uppercase tracking-tight">Syllabus Matrix</h1>
          <p className="text-muted-foreground text-xs sm:text-sm font-medium">Manage and track your progress for {selectedSubject?.name}</p>
        </div>
        ...
        <div className="flex flex-col gap-4 w-full lg:w-auto">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full lg:justify-end">
            <button
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-black rounded-xl border border-primary/20 hover:opacity-90 transition-all text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20"
            >
              <Edit3 size={16} />
              <span>Re-Sync Syllabus</span>
            </button>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-accent/30 text-foreground font-black rounded-xl border border-border hover:bg-accent transition-all text-[10px] uppercase tracking-widest"
              title={selectedSubject?.notesUrl ? "Open Google Drive Notes" : "Open Shared Notes Library"}
            >
              <FileText size={16} />
              <span>Syllabus Assets</span>
            </a>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-input border border-border rounded-xl pl-10 pr-10 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all text-xs text-foreground placeholder:text-muted-foreground/30 font-medium"
              />
            </div>
            ...
            <div className="flex gap-2 shrink-0">
              <div className="relative flex-1 sm:flex-none">
                <select
                  ...
                  className="w-full bg-input border border-border rounded-xl px-4 py-3 text-[10px] font-black uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-primary/50 cursor-pointer text-foreground appearance-none text-center pr-8"
                >
