              ...
              {state.selectedSubjectId && (
                <div className="flex items-center gap-2">
                  <div 
                    ...
                    className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-accent/50 border border-border/50 hover:bg-accent hover:border-primary/30 transition-all cursor-pointer group shrink-0"
                  >
                  ...
                  <a
                    ...
                    className="p-2 rounded-xl bg-primary/5 border border-primary/20 text-primary hover:bg-primary/10 transition-all shadow-sm shrink-0"
                  >
                    <BookOpen size={16} />
                  </a>
                </div>
